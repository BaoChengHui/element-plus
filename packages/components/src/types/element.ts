import type { ElCheckbox, ElCol, ElDatePicker, ElDialog, ElForm, ElFormItem, ElInput, ElInputNumber, ElPagination, ElSelect, ElSelectV2, ElSwitch, ElTable } from 'element-plus'
...
export type ElCheckboxProps = PickComponentProps<typeof ElCheckbox>
...
export type ElTableProps = PickComponentProps<typeof ElTable>
